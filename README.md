...
Esses modos são ativados por palavras-chave no chat do GitHub Copilot (extensão do VS Code).
Ao abrir o chat do Github Capilot no VS Code você clica em "add Context" e anexa a pasta ou o proprio arquivo que estão os textos.md
escreva algo do tipo como "Aja conforme essas diretrizes de (nome do modo)" 

![image](https://github.com/user-attachments/assets/9225f5cd-8b39-425a-b2ae-7df996d1b214)

![image](https://github.com/user-attachments/assets/7523fa87-8f6c-4f19-a790-675aebf7e5ac)


Você pode usar este repositório como base para montar seus próprios perfis de uso.
